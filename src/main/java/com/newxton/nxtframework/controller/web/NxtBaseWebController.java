 ...
 */
public class NxtBaseWebController {
     ...
     */
    protected Map<String,Object> requestApiFromPostReturnMapData(String path, Map<String,Object> params, Map<String,String> header) throws IOException, UnsupportedEncodingException {
