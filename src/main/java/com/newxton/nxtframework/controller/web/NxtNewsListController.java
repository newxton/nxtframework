...
@Controller
public class NxtNewsListController extends NxtBaseWebController {
        ...
        Thread thread0 = new Thread(new Runnable()  {
            ...
            public void run()  {
                try {
                    ...
                    Map<String,Object> data_JSON = requestApiFromPostReturnMapData("/api/normal_news_list",params,null);
